...
namespace StarForce.Editor.DataTableTools
{
    ...
    {
        private const string DataTablePath = "Assets/ETBrain/DataTables";
        private const string CSharpCodePath = "Assets/ETBrain/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/GameFramework/Editor/DataTableGenerator/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "ETBrain");
