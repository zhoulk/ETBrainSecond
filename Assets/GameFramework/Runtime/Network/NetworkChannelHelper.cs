...
namespace UnityGameFramework.Runtime
{
    public class NetworkChannelHelper : INetworkChannelHelper
    {
        ...
        public void Initialize(INetworkChannel networkChannel)
        {
            ...
            Event.Subscribe(NetworkConnectedEventArgs.EventId, OnNetworkConnected);
            Event.Subscribe(NetworkClosedEventArgs.EventId, OnNetworkClosed);
            Event.Subscribe(NetworkMissHeartBeatEventArgs.EventId, OnNetworkMissHeartBeat);
            Event.Subscribe(NetworkErrorEventArgs.EventId, OnNetworkError);
            Event.Subscribe(NetworkCustomErrorEventArgs.EventId, OnNetworkCustomError);
        }
