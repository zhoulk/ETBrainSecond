...
namespace LT.ObjectPool
{
    ...
    public abstract class ObjectBase
    {
        ...
        {
            Guard.Verify<ArgumentException>(target == null, string.Format("Target '{0}' is invalid.", name));

            this.m_Name = name ?? string.Empty;
            this.m_Target = target;
            this.m_Locked = locked;
            this.m_Priority = priority;
            this.m_LastUseTime = DateTime.Now;
        }
        ...
        protected internal abstract void OnRelease(bool isShutdown);
    }
}