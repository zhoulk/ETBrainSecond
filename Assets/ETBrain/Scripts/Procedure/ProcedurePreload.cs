...
namespace ETBrain
{
    public class ProcedurePreload : ProcedureBase
    {
        ...
        protected override internal void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            string assetName = AssetUtility.GetUIFormAsset("LoadingForm");
            GameEntry.UI.OpenUIForm(assetName, "Default", false, this);
        ...
        {
            // Preload configs
            if (BuiltinDataComponent.ChannelType.Unknown.Equals(GameEntry.Builtin.Channel))
            {
                LoadConfig("Channels/channel_default");
            }
            else
            {
                string configName = Utility.Text.Format("Channels/channel_{0}", GameEntry.Builtin.Channel);
