...
namespace ETBrain
{
    public static class EntityExtension
    {
        ...
        {
            entityCompoennt.ShowEntity(data.Id, typeof(Bullet), AssetUtility.GetEntityAsset("PlayerBolt"), "Bullet", Constant.AssetPriority.BulletAsset, data);
        }

        public static void ShowWeapon(this EntityComponent entityComponent, WeaponData data)
        {
            entityComponent.ShowEntity(data.Id, typeof(Weapon), AssetUtility.GetEntityAsset("DefaultWeapon"), "Weapon", Constant.AssetPriority.WeaponAsset, data);
        }

        public static void ShowAsteroid(this EntityComponent entityCompoennt, AsteroidData data)
        {
            entityCompoennt.ShowEntity(data.Id, typeof(Asteroid), AssetUtility.GetEntityAsset("Asteroid01"), "Asteroid", Constant.AssetPriority.AsteroiAsset, data);
        }

        public static void ShowEffect(this EntityComponent entityComponent, EffectData data)
        {
            entityComponent.ShowEntity(data.Id, typeof(Effect), AssetUtility.GetEntityAsset("AsteroidExplosion"), "Effect", Constant.AssetPriority.EffectAsset, data);
        }
